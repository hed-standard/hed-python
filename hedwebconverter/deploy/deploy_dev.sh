...
# deploy.sh - A script used to build and deploy a docker container for the HEDTools hedwebconverter validator
...
DEPLOY_DIR="${ROOT_DIR}/hed-python/hedwebconverter/deploy"
...
HED_XML_DEPLOY_DIR="${CODE_DEPLOY_DIR}/hed/converter/hed"
