...
class SchemaAttributeErrors:
    ...
    SCHEMA_UNIT_CLASS_MULTIPLE = "SCHEMA_UNIT_CLASS_MULTIPLE"
    SCHEMA_UNIT_CLASS_NOT_NUMERIC = "SCHEMA_UNIT_CLASS_NOT_NUMERIC"
    SCHEMA_ANY_UNITS_HAS_UNITS = "SCHEMA_ANY_UNITS_HAS_UNITS"
    SCHEMA_ANY_UNITS_HAS_DEFAULT = "SCHEMA_ANY_UNITS_HAS_DEFAULT"
    SCHEMA_UNIT_DERIVED_IN_TWO_CLASSES = "SCHEMA_UNIT_DERIVED_IN_TWO_CLASSES"
    SCHEMA_UNIT_IN_TWO_CLASSES = "SCHEMA_UNIT_IN_TWO_CLASSES"
    ...
    SCHEMA_ANNOTATION_INVALID = "SCHEMA_ANNOTATION_INVALID"
...
class TemporalErrors:
    ...
    TEMPORAL_TAG_NO_CONVERSION = "TEMPORAL_TAG_NO_CONVERSION"
