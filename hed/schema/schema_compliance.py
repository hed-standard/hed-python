...
from hed.schema import hed_cache, schema_attribute_validators
...
class SchemaValidator:
    ...
    _range_validators = {
        ...
        HedKey.TagRange: [
            partial(schema_attribute_validators.item_exists_check, section_key=HedSectionKey.Tags),
        ],
        HedKey.NumericRange: [
            schema_attribute_validators.is_numeric_value,
        ],
        ...
        HedKey.UnitRange: [
            schema_attribute_validators.unit_exists,
        ],
    ...
    def _build_validators(self, attribute_name):
        ...
        """
        validators = [schema_attribute_validators.attribute_is_deprecated]
