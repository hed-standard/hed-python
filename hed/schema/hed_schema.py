...
class HedSchema(HedSchemaBase):
    ...
    def get_tags_with_attribute(self, attribute, key_class=HedSectionKey.Tags) -> list["HedSchemaEntry"]:
        ...
        """
        return self._sections[key_class].get_entries_with_attribute(
            attribute, return_name_only=True, schema_namespace=self._namespace
        )
    ...
    def get_tag_attribute_names_old(self) -> dict[str, HedSchemaEntry]:
        ...
        return {
            ...
            for tag_entry in self._sections[HedSectionKey.Attributes].values()
    ...
    def _add_element_property_attributes(self, attribute_dict, attribute_name):
        attributes = {
            attribute: entry
            for attribute, entry in self._sections[HedSectionKey.Attributes].items()
