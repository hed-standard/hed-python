...
class HedTagSummary:
    ...
    Attributes:
        ...
        schema (HedSchema or Hed): The HED schema
        breakout_list (list):  The breakout list if not the default.
    ...
    def __init__(self, file_group, schema, breakout_list=None):
        ...
        if not breakout_list:
            self.breakout_list = HedTagSummary.BREAKOUT_LIST
    ...
    def extract_summary_info(entry_dict, tag_name):
        """ Extract the summary of tags in this entry.
...
if __name__ == '__main__':
    ...
    summary = HedTagSummary(event_group, schema=bids.schema, breakout_list=breakouts)
    print('to here')
