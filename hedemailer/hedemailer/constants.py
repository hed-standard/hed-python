...
NO_EMAIL_LIST_ERROR = "Email list file either doesn't exist or contained no email addresses"
...
HED_WIKI_URL = 'https://raw.githubusercontent.com/VisLab/hed-specification-working/HED-restructure/HED-schema.mediawiki'
