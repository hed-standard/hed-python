...
%% Example 1: Validate valid events file using HED version.
sdata1 = struct('service', 'events_validate', 'service_parameters', []);
...
sdata2 = struct('service', 'events_validate', 'service_parameters', []);
...
sdata3 = struct('service', 'events_assemble', 'service_parameters', []);
...
%%  Example 4: Assemble valid events file (def expand) using HED version.
sdata4 = struct('service', 'events_assemble', 'service_parameters', []);
parameters = struct('schema_version', '8.0.0-alpha.1', ...
                    'json_string', json_text, ...
                    'events_string', events_text, ...
                    'check_for_warnings', true, ...
