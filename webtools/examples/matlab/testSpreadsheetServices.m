...
parameters = ...
    struct('schema_version', '7.2.0', ...
           ...
           'check_warnings_validate', true, 'has_column_names', true, ...
           'column_2_input', 'Event/Label/', 'column_2_check', 'on', ...
           'column_5_input', '', 'column_5_check', 'on');
sdata1 = struct('service', 'spreadsheet_validate', ....
...
parameters = ...
    struct('schema_url', schema_url, ...
           ...
           'column_2_input', 'Event/Label/', 'column_2_check', 'on', ...
           'column_5_input', '', 'column_5_check', 'on');
sdata2 = struct('service', 'spreadsheet_validate', ...
                'service_parameters', parameters);
...
parameters = ...
    struct('schema_string', schema_text, ...
           ...
           'column_5_input', '', 'column_5_check', 'on');
sdata3 = struct('service', 'spreadsheet_to_long', ...
                'service_parameters', parameters);
...
parameters = ...
    struct('schema_string', schema_text, ...
           'spreadsheet_string', spreadsheet_text_HED3, ...
           'check_warnings', true, 'has_column_names', true, ...
           'column_2_input', labelPrefix, 'column_2_check', 'on', ...
           'column_4_input', descPrefix, 'column_4_check', 'on', ...
           'column_5_input', '', 'column_5_check', 'on');
sdata4 = struct('service', 'spreadsheet_to_short', ...
                'service_parameters', parameters);
