...
% 
%  Example 1: Validate a correct JSON dictionary. HED schema is version.
%
%  Example 2: Validate an incorrect JSON dictionary. HED schema is URL.
%
%  Example 3: Convert a valid JSON dictionary to long. Upload HED schema.
%
%  Example 4: Convert valid JSON dictionary to short. HED schema is version.
%
