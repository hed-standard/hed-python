...
def hedstring_convert(arguments, short_to_long=True):
    ...
    if short_to_long:
        return_str, issues = tag_formatter.convert_hed_string_to_long(arguments.get(common.HEDSTRING))
    else:
        return_str, issues = tag_formatter.convert_hed_string_to_short(arguments.get(common.HEDSTRING))
