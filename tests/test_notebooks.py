...
class TestNotebooks(unittest.TestCase):
    ...
    def test_notebooks_directory_exists(self):
        ...
        self.assertTrue(self.examples_dir.exists(), f"Examples directory not found: {self.examples_dir}")

        notebooks = list(self.examples_dir.glob("*.ipynb"))
        self.assertGreater(len(notebooks), 0, "No notebooks found in examples directory")
                ...
                for cell_source in import_cells:
                    ...
                    for line in lines:
                        ...
                        if line.startswith("import ") or line.startswith("from "):
                            ...
                            self.assertNotIn(",,", line, f"Syntax error in import: {line}")
                            self.assertNotIn("..", line, f"Invalid import path: {line}")
    ...
    def test_extract_json_template_notebook(self):
        ...
        self.assertTrue(
            "get_new_dataframe" in all_code or "extract_sidecar_template" in all_code,
    ...
    def test_notebook_execution_structure(self):
        ...
        for notebook_name in notebooks:
            ...
            with self.subTest(notebook=notebook_name):
                ...
                ep = self.ExecutePreprocessor(timeout=60, kernel_name="python3")
                self.assertIsNotNone(ep, f"Could not create executor for {notebook_name}")
