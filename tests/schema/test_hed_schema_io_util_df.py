...
class TestMergeDataFrames(unittest.TestCase):
    def setUp(self):
        ...
        self.df1 = pd.DataFrame({"label": [1, 2, 3], "A_col1": ["A1", "A2", "A3"], "A_col2": [10, 20, 30]})

        self.df2 = pd.DataFrame({"label": [2, 3, 4], "B_col1": ["B2", "B3", "B4"], "A_col2": [200, 300, 400]})
    ...
    def test_missing_label_column_raises_error(self):
        ...
        df_no_label = pd.DataFrame({"A_col1": ["A1", "A2", "A3"], "A_col2": [10, 20, 30]})
