...
class TestHedSchema(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.files_and_errors = {
            ...
            "HED_header_missing.mediawiki": HedExceptions.SCHEMA_HEADER_INVALID,
            ...
            "HED_header_unknown_attribute.mediawiki": HedExceptions.SCHEMA_HEADER_INVALID,
            "HED_header_bad_library.mediawiki": HedExceptions.SCHEMA_LIBRARY_INVALID,
