...
class TestConvertTag(TestTagFormat):
    def converter_base(self, test_strings, expected_results, expected_errors, convert_to_short=True):
        for test_key in test_strings:
            ...
            test_issues = test_string_obj._calculate_to_canonical_forms(self.hed_schema)
            if convert_to_short:
            ...
            expected_issue = self.format_errors_fully(error_handler, hed_string=test_string_obj, params=expected_params)
...
class TestConvertToLongTag(TestConvertTag):
    ...
    def test_tag_invalid_extension(self):
        ...
        expected_errors = {
            ...
            "singleLevelAlreadyLong": self.format_error(
                ValidationErrors.INVALID_PARENT_NODE,
                tag=0,
                index_in_tag=25,
                index_in_tag_end=41,
...
class TestConvertToShortTag(TestConvertTag):
    ...
    def test_tag_invalid_extension(self):
        ...
        expected_errors = {
            ...
            "singleLevelAlreadyShort": self.format_error(
                ValidationErrors.INVALID_PARENT_NODE,
                tag=0,
                index_in_tag=19,
                index_in_tag_end=35,
    ...
    def test_string_invalid(self):
        ...
        expected_errors = {
            ...
            "singleWithTwoValid": self.format_error(
                ValidationErrors.NO_VALID_TAG_FOUND, tag=1, index_in_tag=0, index_in_tag_end=12
            ),
            "doubleWithValid": self.format_error(
                ValidationErrors.NO_VALID_TAG_FOUND, tag=0, index_in_tag=0, index_in_tag_end=12
            ),
        }
        self.validator(test_strings, expected_results, expected_errors)
