...
class TestSchemaComparison(unittest.TestCase):
    ...
    def test_find_matching_tags(self):
        ...
        comp1 = SchemaComparer(schema1, schema2)
        result = comp1.find_matching_tags(return_string=False)
        ...
        match_string = comp1.find_matching_tags()
    ...
    def test_compare_schemas(self):
        ...
        schema2 = util_create_schemas.load_schema2()
        comp1 = SchemaComparer(schema1, schema2)
        matches, not_in_schema1, not_in_schema2, unequal_entries = comp1.compare_schemas()
    ...
    def test_compare_and_summarize_schemas_test(self):
        ...
        comp1 = SchemaComparer(schema1, schema2)
        result = comp1.gather_schema_changes()
        self.assertEqual(sum(len(x) for x in result.values()), 30)
        schema_string = comp1.pretty_print_change_dict(result, title=f"Differences between {schema1.name} and {schema2.name}")
    ...
    def test_compare_differences(self):
        ...
        schema2 = util_create_schemas.load_schema2()
        comp1 = SchemaComparer(schema1, schema2)
        _, not_in_schema1, not_in_schema2, unequal_entries = comp1.compare_schemas()
        ...
        diff_string_with_summary = comp1.compare_differences()
    ...
    def test_compare_score_lib_versions(self):
        ...
        comp1 = SchemaComparer(schema1, schema2)
        _, not_in_schema1, not_in_schema2, unequal_entries = comp1.compare_schemas(attribute_filter=HedKey.InLibrary)
        ...
        diff_string = comp1.compare_differences(attribute_filter=HedKey.InLibrary)
