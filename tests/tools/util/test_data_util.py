...
class Test(unittest.TestCase):
    ...
    def test_add_column(self):
        data = {"Name": ["n/a", "", "tom", "alice", 0, 1], "Age": [np.nan, 10, "", "n/a", "0", "10"]}
        df1 = DataFrame(data)
    ...
    def test_check_match(self):
        data1 = {"Name": ["n/a", "", "tom", "alice", 0, 1], "Age": [np.nan, 10, "", "n/a", "0", "10"]}
        data2 = {"Blame": ["n/a", "", "tom", "alice", 0, 1], "Rage": [np.nan, 10, "", "n/a", "0", "10"]}
        df1 = DataFrame(data1)
        df2 = DataFrame(data2)
        ...
        self.assertFalse(errors, "There should not be errors if the items are compared as strings")
        data3 = {"Blame": ["n/a", "", "tom", "alice", 0, 1], "Rage": [np.nan, 10, "", "1", "0", 30]}
        df3 = DataFrame(data3)
    ...
    def test_replace_values(self):
        ...
        self.assertEqual(
            1, num_replaced2, "replace_values should replace the correct number of values when columns are specified"
        )
