...
class Test(unittest.TestCase):
    ...
    def test_get_summary(self):
        ...
        # summary2 = context1.get_summary(as_json=False)
        ...
        # summary_text3 = context1.get_text_summary(include_individual=False, separate_files=True)
        ...
        # summary_text4 = context1.get_text_summary(include_individual=True, separate_files=False)
        # self.assertIsInstance(summary_text4, dict)
        # summary_text5 = context1.get_text_summary(include_individual=False, separate_files=False)
        ...
        # self.assertIsInstance(context1, EventsToSidecarSummaryContext, "get_summary testing EventsToSidecarSummary")
        # summary_text6 = context2.get_text_summary(include_individual=True, separate_files=True)
