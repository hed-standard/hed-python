...
class Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.test_zip_ds002790 = os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                             '../../../data/remodeling/test_ds002790s_hed_bad.zip')
        cls.test_root_ds002790 = 'test_ds002790s_hed'
        cls.test_zip_ds003654 = os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                             '../../../data/remodeling/test_ds003654s_hed_bad.zip')
        cls.test_root_ds003654 = 'test_ds003654s_hed'
    ...
    def test_main_rename_columns(self):
        derv_path = os.path.realpath(os.path.join(self.test_root_ds002790,
