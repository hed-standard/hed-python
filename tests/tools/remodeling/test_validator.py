...
class Test(unittest.TestCase):
    ...
    def test_validate_array(self):
        ...
        self.assertEqual(error_strings[0],
                         "Operations must be contained in a list or array. This is also true when you run a single operation.")
    ...
    def test_validate_parameters(self):
        ...
        self.assertEqual(error_strings[0],
                         "Operation 1: The field onset_source is missing in response, new_events. onset_source is a required parameter of response, new_events.")
        ...
        self.assertEqual(error_strings[0],
                         "Operation 1: The list in copy_columns, response, new_events, in the split_rows operation, should only contain unique items.")
