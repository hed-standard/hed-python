...
class Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.test_zip = os.path.join(os.path.dirname(os.path.realpath(__file__)), '../../data/remodeling/test_root.zip')
        ...
        test_root_bad = os.path.join(os.path.dirname(os.path.realpath(__file__)), '../../data/remodeling/test_root_bad')
