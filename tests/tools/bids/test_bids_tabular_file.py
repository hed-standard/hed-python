...
class Test(unittest.TestCase):
    ...
    def test_set_contents_with_sidecar(self):
        ...
        events.sidecar = sidecar
        sidecar.set_contents()
        self.assertTrue(events.sidecar.contents, "The events sidecar has contents after setting")
        self.assertTrue(events.sidecar.has_hed, "The sidecar has HED")
