...
class Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        event_path = "../../data/other_tests/sub-001_task-AuditoryVisualShift_run-01_events.tsv"
        cls.event_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), event_path)

        hed_col_path = "../../data/other_tests/sub-002withHed_task-FacePerception_run-1_events.tsv"
        cls.event_path_hed_col = os.path.join(os.path.dirname(os.path.realpath(__file__)), hed_col_path)

        sidecar_path = "../../data/other_tests/task-AuditoryVisualShift_events.json"
