...
class Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.demo_path = os.path.join(os.path.dirname(os.path.realpath(__file__)),
        ...
        cls.inherit_path = os.path.join(os.path.dirname(os.path.realpath(__file__)),
                                        '../../data/bids_tests/eeg_ds003645s_hed_inheritance')
    ...
    def test_basic_with_suffixes(self):
        ...
        self.assertFalse(issues,
                         "BidsDataset validate should not return issues when the default check_for_warnings is used")
    ...
    def test_inheritance_no_suffixes(self):
        ...
        self.assertEqual(merged2["face_type"]["HED"]["famous_face"],  "Def/Famous-face-cond, Label/Famous",
                         "The merged sidecar should have a overwritten famous_face")
        self.assertEqual(sidecar1.contents.loaded_dict["face_type"]["HED"]["famous_face"], "Def/Famous-face-cond",
