...
class Test(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertEqual(len(events.events_dict), 6, "BidsEventFiles event files dictionary should have 2 entries")
    ...
    def test_validator(self):
        ...
        validation_issues = events.validate_events(hed_ops=[validator], check_for_warnings=False)
        self.assertFalse(validation_issues, "BidsEventFiles should have no validation errors")
        validation_issues = events.validate_events(hed_ops=[validator], check_for_warnings=True)
