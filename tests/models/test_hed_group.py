...
class Test(unittest.TestCase):
    ...
    def test_sort_and_sorted(self):
        hed_strings = ["A, B, C", "A, C, B", "B, C, A", "C, B, A"]
        self._compare_strings(hed_strings)
        self._compare_strings2(hed_strings)
        hed_strings = ["A, (B, C)", "(B, C), A"]
        self._compare_strings(hed_strings)
        self._compare_strings2(hed_strings)
        hed_strings = ["A, (A, (B, C))", "(A, (B, C)), A", "((B, C), A), A", "A, ((B, C), A)"]
        self._compare_strings(hed_strings)
        self._compare_strings2(hed_strings)
        hed_strings = ["D, A, (A, (B, C))", "(A, (B, C)), A, D", "((B, C), A), A, D", "A, D, ((B, C), A)"]
        self._compare_strings(hed_strings)
        self._compare_strings2(hed_strings)
        hed_strings = [
            "D, (E, F), A, (A, (B, C))",
