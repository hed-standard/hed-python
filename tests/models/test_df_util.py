...
class TestConvertToForm(unittest.TestCase):
    ...
    def test_basic_expand_detection(self):
        ...
        test_strings = [
            "(Def-expand/A1/1, (Action/1, Age/5, Item-count/3))",
    ...
    def test_mixed_detection(self):
        ...
        test_strings = [
            ...
            "(Def-expand/B2/3, (Action/3, Collection/animals, Age/3))",
            "(Def-expand/B2/4, (Action/4, Collection/animals, Age/3))",
            # Multiple tags
            "(Def-expand/C3/5, (Action/5, Age/5, Item-count/5))",
            "(Def-expand/C3/6, (Action/6, Age/5, Item-count/5))",
            # Multiple tags2
            "(Def-expand/D4/7, (Action/7, Age/7, Item-count/8))",
            "(Def-expand/D4/8, (Action/8, Age/7, Item-count/8))"
            # Multiple tags3
            "(Def-expand/D5/7, (Action/7, Age/7, Item-count/8, Event))",
            "(Def-expand/D5/8, (Action/8, Age/7, Item-count/8, Event))"
        ]
    ...
    def test_def_expand_detection(self):
        test_strings = [
            ...
            "(Def-expand/C3/5, (Action/5, Joyful, Event))",
            "(Def-expand/C3/6, (Action/6, Joyful, Event))",
            "((Def-expand/A1/7, (Action/7, Age/5, Item-Count/2)), Event, Age/10)",
            "((Def-expand/A1/8, (Action/8, Age/5, Item-Count/2)), Collection/toys, Item-Count/5)",
            ...
            "((Def-expand/C3/11, (Action/11, Joyful, Event)), Collection/vehicles, Age/20)",
