    ...
    def test_exist_in_schema(self):
        ...
        expected_issues = {
            ...
            "usedToBeIllegalComma": self.format_error(
                ValidationErrors.NO_VALID_TAG_FOUND, tag=1, index_in_tag=3, index_in_tag_end=7
            ),
            "legalDef": [],
            "legalDefExpand": [],
            ...
            "semivalid2": [
                {
                    ...
                    "message": "'tl:Onset' tag has no def tag or def-expand group or too many when 1 is required in string.",
                    "severity": 1,
                }
            ],
        }
    ...
    def test_multiple_copies_unique_tags(self):
        ...
        expected_issues = {
            ...
            "multipleDesc": self.format_error(
                ValidationErrors.TAG_NOT_UNIQUE, tag_namespace="tl:Property/Organizational-property/Event-context"
            ),
