...
class KeyMap2:
    ...
    def __init__(self, data, key_cols, target_cols=None, name=''):
        """ Class stores base data for doing event remapping.

        Args:
            data (str or Dataframe) Data holding the map
    ...
    def _create_map(self, data):
        ...
        base_df = pd.DataFrame(columns=self.key_cols + self.target_cols)
