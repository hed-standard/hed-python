...
STRING_ATTRIBUTE_DICTIONARY_KEYS = [HedKey.AllowedCharacter, HedKey.Default, HedKey.UnitClass,
...
UNIT_CLASS_ATTRIBUTES = [HedKey.DefaultUnits, HedKey.SIUnit, HedKey.UnitSymbol, HedKey.AllowedCharacter]
