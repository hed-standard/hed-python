...
class TestValidatorUtilityFunctions(TestHed):
    def test_if_tag_exists(self):
        valid_tag1 = HedTag('attribute/direction/left')
        valid_tag1.convert_to_canonical_forms(self.hed_schema)
        valid_tag2 = HedTag('item/object/person')
        valid_tag2.convert_to_canonical_forms(self.hed_schema)
        valid_tag3 = HedTag('event/duration/#')
        valid_tag3.convert_to_canonical_forms(self.hed_schema)
        invalid_tag1 = HedTag('something')
        invalid_tag1.convert_to_canonical_forms(self.hed_schema)
        invalid_tag2 = HedTag('Participant/nothing')
        invalid_tag2.convert_to_canonical_forms(self.hed_schema)
        invalid_tag3 = HedTag('participant/#')
        invalid_tag3.convert_to_canonical_forms(self.hed_schema)
