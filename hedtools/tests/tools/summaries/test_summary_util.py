...
class Test(unittest.TestCase):
    ...
    def test_breakout_tags(self):
        breakout_list = Test.rules["Tag-categories"]
        ...
        breakout_dict = breakout_tags(Test.schema, tag_list, breakout_list)
    ...
    def test_get_schema_entries(self):
        tag1 = 'Red'
        schema_entries1 = get_schema_entries(Test.schema, tag1)
        ...
        schema_entries2 = get_schema_entries(Test.schema, tag2)
    ...
    def test_add_tag_list_to_dict(self):
        ...
        tag_dict1 = {}
        add_tag_list_to_dict([hed1], tag_dict1, Test.schema)
        ...
        tag_dict3 = {}
        add_tag_list_to_dict([HedString(Test.str1), HedString(Test.str2), HedString(Test.str_with_def)],
                             tag_dict3, Test.schema)
