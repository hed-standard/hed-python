#!/usr/bin/env python
"""
# The *hedtools* on Docker wrapper
#
# This is a lightweight Python wrapper to run various hedtools in a docker container.
# Docker must be installed and running. This can be checked
# running the following command in a command window:
#
#   docker info
#
# """
...
# __copyright__ = 'Copyright 2021, HED standards group'
# __credits__ = []
# __bugreports__ = 'https://github.com/hed-standard/hed-python/issues'
#
#
# # MISSING = """
# # Image '{}' is missing
